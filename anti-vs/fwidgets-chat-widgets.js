...
(function() {
  var __astigDeployStamp = "2026-03-09T21:28:38.611Z";
  ...
  if (!window.RSVPChatConfig.fullConfig || typeof window.RSVPChatConfig.fullConfig !== 'object') window.RSVPChatConfig.fullConfig = {"theme":{"primaryColor":"#6ee7ff","bgColor":"#22014d","surfaceColor":"#2a0a67","fontFamily":"","borderRadius":30,"mode":"solid","gradient":{"start":"#6c63ff","end":"#ff6584"},"headerBgColor":"#2a0a67","headerTextColor":"#ffffff","topHeroMediaType":"none","topHeroMediaUrl":""},"header":{"title":"Max Customer Support","name":"Max Customer Support","status":"3D live support for orders, questions, and agent handoff.","fontFamily":"'Syne', sans-serif","nameFontSize":29,"nameFontWeight":800,"statusFontSize":12,"animation":"none","logoOffsetX":0,"logoOffsetY":0,"nameOffsetX":0,"nameOffsetY":0,"statusOffsetX":0,"statusOffsetY":0,"avatar":"https://widjets.astigmedia.com/img/Assistant-logo.png","avatarSize":"40","logoSize":"58","logoType":"image","logoUrl":"https://widjets.astigmedia.com/img/main-logo.png"},"assistant":{"name":"River"},"user":{"avatar":"https://widjets.astigmedia.com/img/User-logo.png","avatarSize":"40"},"launcher":{"position":"bottom-right","shape":"circle","iconType":"image","icon":"bot","imageUrl":"https://widjets.astigmedia.com/img/Launcher-Logo.png","size":"54","badgeEnabled":true,"text":"Chat with us!","bubbleEnabled":false,"bubbleText":"Ta-da! You've found your creative superpower spot.","bubbleMode":"instant","bubbleTimed":false,"bubbleDelaySec":5,"bubbleDurationSec":10,"bgStyle":"gradient","bgColor":"#5b18b5","gradientEnd":"#ff54cf","animation":"pulse"},"video":{"layout":"inline","hideBehavior":"first-question","loop":false,"url":"","imageUrl":""},"questions":[{"id":1,"text":"Welcome to Max Customer Support. Pick a lane and we will route you fast.","type":"text","displayMode":"instant","choices":""},{"id":2,"text":"What do you need help with?","type":"choice","displayMode":"instant","choices":"Track an order,Technical issue,Talk to support"}],"questionsStyle":"solid","webhook":{"url":"https://n8n.srv1291312.hstgr.cloud/webhook/a4d3520b-1922-4e9b-b162-3b15a5060985/chat","testUrl":"","chatUrl":"https://n8n.srv1291312.hstgr.cloud/webhook/a4d3520b-1922-4e9b-b162-3b15a5060985/chat","activeMode":"production","production":true,"externalJsUrl":"https://cdn.jsdelivr.net/gh/majesticwebcreation-ui/astig.media@840893a01945523ab22d8e81f9a7e797c95cea52/anti-vs/fwidgets-chat-embed-runtime.js"},"auth":{"enabled":true,"headerName":"Authorization","headerPrefix":"Bearer","headerValue":"Basic SmFycm9kOlJpdmVyMjk3MyE=","useForWebhook":true,"withCredentials":false},"converse":{"typingEnabled":true,"typingText":"","statusDelaySec":5,"minVisibleSec":0.8,"animation":"bounce","bubbleFill":"solid","bubbleShape":"soft","indicatorColor":"#7070a0","bubbleBgColor":"#2a2a3d","bubbleGradientEnd":"#4b4f64"},"footer":{"text":"","url":"","fontFamily":"'Inter', sans-serif","animation":"none","textColor":"#7070a0","fontSize":"11","position":"center"},"ui":{"showPipelineMonitor":false,"showRealtimeTelemetry":false,"showRealtimeFeed":false,"templateStyle":"max-customer-support"}};
...
(function() {
    ...
    const defaultBundleConfig = {"theme":{"primaryColor":"#6ee7ff","bgColor":"#22014d","surfaceColor":"#2a0a67","fontFamily":"","borderRadius":30,"mode":"solid","gradient":{"start":"#6c63ff","end":"#ff6584"},"headerBgColor":"#2a0a67","headerTextColor":"#ffffff","topHeroMediaType":"none","topHeroMediaUrl":""},"header":{"title":"Max Customer Support","name":"Max Customer Support","status":"3D live support for orders, questions, and agent handoff.","fontFamily":"'Syne', sans-serif","nameFontSize":29,"nameFontWeight":800,"statusFontSize":12,"animation":"none","logoOffsetX":0,"logoOffsetY":0,"nameOffsetX":0,"nameOffsetY":0,"statusOffsetX":0,"statusOffsetY":0,"avatar":"https://widjets.astigmedia.com/img/Assistant-logo.png","avatarSize":"40","logoSize":"58","logoType":"image","logoUrl":"https://widjets.astigmedia.com/img/main-logo.png"},"assistant":{"name":"River"},"user":{"avatar":"https://widjets.astigmedia.com/img/User-logo.png","avatarSize":"40"},"launcher":{"position":"bottom-right","shape":"circle","iconType":"image","icon":"bot","imageUrl":"https://widjets.astigmedia.com/img/Launcher-Logo.png","size":"54","badgeEnabled":true,"text":"Chat with us!","bubbleEnabled":false,"bubbleText":"Ta-da! You've found your creative superpower spot.","bubbleMode":"instant","bubbleTimed":false,"bubbleDelaySec":5,"bubbleDurationSec":10,"bgStyle":"gradient","bgColor":"#5b18b5","gradientEnd":"#ff54cf","animation":"pulse"},"video":{"layout":"inline","hideBehavior":"first-question","loop":false,"url":"","imageUrl":""},"questions":[{"id":1,"text":"Welcome to Max Customer Support. Pick a lane and we will route you fast.","type":"text","displayMode":"instant","choices":""},{"id":2,"text":"What do you need help with?","type":"choice","displayMode":"instant","choices":"Track an order,Technical issue,Talk to support"}],"questionsStyle":"solid","webhook":{"url":"https://n8n.srv1291312.hstgr.cloud/webhook/a4d3520b-1922-4e9b-b162-3b15a5060985/chat","testUrl":"","chatUrl":"https://n8n.srv1291312.hstgr.cloud/webhook/a4d3520b-1922-4e9b-b162-3b15a5060985/chat","activeMode":"production","production":true,"externalJsUrl":"https://cdn.jsdelivr.net/gh/majesticwebcreation-ui/astig.media@840893a01945523ab22d8e81f9a7e797c95cea52/anti-vs/fwidgets-chat-embed-runtime.js"},"auth":{"enabled":true,"headerName":"Authorization","headerPrefix":"Bearer","headerValue":"Basic SmFycm9kOlJpdmVyMjk3MyE=","useForWebhook":true,"withCredentials":false},"converse":{"typingEnabled":true,"typingText":"","statusDelaySec":5,"minVisibleSec":0.8,"animation":"bounce","bubbleFill":"solid","bubbleShape":"soft","indicatorColor":"#7070a0","bubbleBgColor":"#2a2a3d","bubbleGradientEnd":"#4b4f64"},"footer":{"text":"","url":"","fontFamily":"'Inter', sans-serif","animation":"none","textColor":"#7070a0","fontSize":"11","position":"center"},"ui":{"showPipelineMonitor":false,"showRealtimeTelemetry":false,"showRealtimeFeed":false,"templateStyle":"max-customer-support"}};
    ...
    function resolveWebhookAuthContext(cfg, runtimeConfig) {
        ...
        var enabled = (runtimeAuth.enabled !== undefined ? runtimeAuth.enabled : configAuth.enabled) !== false;
        var useForWebhook = (runtimeAuth.useForWebhook !== undefined ? runtimeAuth.useForWebhook : configAuth.useForWebhook) !== false;
        var withCredentials = (runtimeAuth.withCredentials !== undefined ? runtimeAuth.withCredentials : configAuth.withCredentials) === true;
        var headerName = String(runtimeAuth.headerName || configAuth.headerName || 'Authorization').trim() || 'Authorization';
        var headerValue = String(runtimeAuth.headerValue || configAuth.headerValue || '').trim();
        return {
            enabled: enabled,
            useForWebhook: useForWebhook,
