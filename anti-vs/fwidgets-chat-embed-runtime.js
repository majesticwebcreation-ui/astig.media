...
(function() {
  var __astigDeployStamp = "2026-03-08T21:07:30.142Z";
  ...
  if (!window.RSVPChatConfig.fullConfig || typeof window.RSVPChatConfig.fullConfig !== 'object') window.RSVPChatConfig.fullConfig = {"theme":{"primaryColor":"#57d8e5","bgColor":"#edf4f4","surfaceColor":"#f7fbfb","fontFamily":"'DM Sans', sans-serif","borderRadius":30,"mode":"solid","gradient":{"start":"#6c63ff","end":"#ff6584"},"headerBgColor":"#edf4f4","headerTextColor":"#66758b","topHeroMediaType":"none","topHeroMediaUrl":""},"header":{"title":"Max Customer Service","name":"Max Customer Service","status":"Soft 3D response layout for service, help, and support routing.","fontFamily":"'Syne', sans-serif","nameFontSize":26,"nameFontWeight":800,"statusFontSize":12,"animation":"none","logoOffsetX":0,"logoOffsetY":0,"nameOffsetX":0,"nameOffsetY":0,"statusOffsetX":0,"statusOffsetY":0,"avatar":"MS","avatarSize":"40","logoSize":"52","logoType":"text","logoUrl":""},"assistant":{"name":"Max Service"},"user":{"avatar":"","avatarSize":"0"},"launcher":{"position":"bottom-right","iconType":"icon","icon":"message-circle-more","imageUrl":"","size":"52","badgeEnabled":false,"text":"","bubbleEnabled":false,"bubbleText":"Ta-da! You've found your creative superpower spot.","bubbleMode":"instant","bubbleTimed":false,"bubbleDelaySec":5,"bubbleDurationSec":10,"bgStyle":"gradient","bgColor":"#64d9df","gradientEnd":"#73a7ff","animation":"pulse"},"video":{"layout":"inline","hideBehavior":"first-question","loop":false,"url":"","imageUrl":""},"questions":[{"id":1,"text":"Phone text bubble","type":"text","displayMode":"instant","choices":""},{"id":2,"text":"How can we help today?","type":"choice","displayMode":"instant","choices":"Billing help,Order status,Talk to a service agent"}],"questionsStyle":"solid","webhook":{"url":"https://n8n.srv1291312.hstgr.cloud/webhook/a368d690-b760-49a9-ba19-67c4a6971fa3/chat","testUrl":"","chatUrl":"https://n8n.srv1291312.hstgr.cloud/webhook/a368d690-b760-49a9-ba19-67c4a6971fa3/chat","activeMode":"chat","production":false,"externalJsUrl":"https://cdn.jsdelivr.net/gh/majesticwebcreation-ui/astig.media@main/anti-vs/fwidgets-chat-embed-runtime.js"},"auth":{"enabled":true,"headerName":"Authorization","headerPrefix":"Bearer","headerValue":"Basic SmFycm9kOlJpdmVyMjk3MyE=","useForWebhook":true,"withCredentials":false},"footer":{"text":"","url":"","fontFamily":"'Inter', sans-serif","animation":"none","textColor":"#7070a0","fontSize":"11","position":"center"},"ui":{"showPipelineMonitor":false,"showRealtimeTelemetry":false,"showRealtimeFeed":false,"templateStyle":"max-customer-service"}};
...
(function() {
    ...
    const defaultBundleConfig = {"theme":{"primaryColor":"#57d8e5","bgColor":"#edf4f4","surfaceColor":"#f7fbfb","fontFamily":"'DM Sans', sans-serif","borderRadius":30,"mode":"solid","gradient":{"start":"#6c63ff","end":"#ff6584"},"headerBgColor":"#edf4f4","headerTextColor":"#66758b","topHeroMediaType":"none","topHeroMediaUrl":""},"header":{"title":"Max Customer Service","name":"Max Customer Service","status":"Soft 3D response layout for service, help, and support routing.","fontFamily":"'Syne', sans-serif","nameFontSize":26,"nameFontWeight":800,"statusFontSize":12,"animation":"none","logoOffsetX":0,"logoOffsetY":0,"nameOffsetX":0,"nameOffsetY":0,"statusOffsetX":0,"statusOffsetY":0,"avatar":"MS","avatarSize":"40","logoSize":"52","logoType":"text","logoUrl":""},"assistant":{"name":"Max Service"},"user":{"avatar":"","avatarSize":"0"},"launcher":{"position":"bottom-right","iconType":"icon","icon":"message-circle-more","imageUrl":"","size":"52","badgeEnabled":false,"text":"","bubbleEnabled":false,"bubbleText":"Ta-da! You've found your creative superpower spot.","bubbleMode":"instant","bubbleTimed":false,"bubbleDelaySec":5,"bubbleDurationSec":10,"bgStyle":"gradient","bgColor":"#64d9df","gradientEnd":"#73a7ff","animation":"pulse"},"video":{"layout":"inline","hideBehavior":"first-question","loop":false,"url":"","imageUrl":""},"questions":[{"id":1,"text":"Phone text bubble","type":"text","displayMode":"instant","choices":""},{"id":2,"text":"How can we help today?","type":"choice","displayMode":"instant","choices":"Billing help,Order status,Talk to a service agent"}],"questionsStyle":"solid","webhook":{"url":"https://n8n.srv1291312.hstgr.cloud/webhook/a368d690-b760-49a9-ba19-67c4a6971fa3/chat","testUrl":"","chatUrl":"https://n8n.srv1291312.hstgr.cloud/webhook/a368d690-b760-49a9-ba19-67c4a6971fa3/chat","activeMode":"chat","production":false,"externalJsUrl":"https://cdn.jsdelivr.net/gh/majesticwebcreation-ui/astig.media@main/anti-vs/fwidgets-chat-embed-runtime.js"},"auth":{"enabled":true,"headerName":"Authorization","headerPrefix":"Bearer","headerValue":"Basic SmFycm9kOlJpdmVyMjk3MyE=","useForWebhook":true,"withCredentials":false},"footer":{"text":"","url":"","fontFamily":"'Inter', sans-serif","animation":"none","textColor":"#7070a0","fontSize":"11","position":"center"},"ui":{"showPipelineMonitor":false,"showRealtimeTelemetry":false,"showRealtimeFeed":false,"templateStyle":"max-customer-service"}};
    ...
    if (!document.getElementById('astig-chat-max-customer-support-style')) {
        const maxCustomerSupportStyle = document.createElement('style');
        maxCustomerSupportStyle.id = 'astig-chat-max-customer-support-style';
        maxCustomerSupportStyle.textContent = `
    .chat-widget.chat-widget--max-customer-support{background:radial-gradient(circle at 18% 12%, rgba(255,84,207,.28) 0%, rgba(255,84,207,0) 30%),radial-gradient(circle at 78% 82%, rgba(74,240,255,.2) 0%, rgba(74,240,255,0) 28%),linear-gradient(180deg, #4e0f93 0%, #2d0968 52%, #170233 100%);border-color:rgba(155,120,255,.42);border-radius:34px;box-shadow:0 34px 60px rgba(15,0,51,.5), inset 0 1px 0 rgba(255,255,255,.1);}
    .chat-widget.chat-widget--max-customer-support::before{content:'';position:absolute;inset:43% -18% -12% -18%;background-image:linear-gradient(rgba(88,111,255,.18) 1px, transparent 1px),linear-gradient(90deg, rgba(88,111,255,.18) 1px, transparent 1px);background-size:34px 30px;opacity:.32;transform:perspective(900px) rotateX(76deg);transform-origin:top center;pointer-events:none;}
    .chat-widget.chat-widget--max-customer-support::after{content:'';position:absolute;inset:0;background:radial-gradient(circle at 50% 54%, rgba(124,58,237,.16), transparent 34%),radial-gradient(circle at 50% 92%, rgba(69,229,255,.16), transparent 18%);pointer-events:none;}
    .chat-widget.chat-widget--max-customer-support .chat-widget__header{position:relative;z-index:2;background:transparent;border-bottom:none;padding:24px 22px 10px;gap:14px;}
    .chat-widget.chat-widget--max-customer-support .chat-widget__header-avatar{width:58px;height:58px;border-radius:20px;background:linear-gradient(160deg, #f7f1ff 0%, #c9b9ff 45%, #7358ff 100%);border:1px solid rgba(255,255,255,.42);box-shadow:0 14px 28px rgba(9,0,44,.36), inset 0 2px 4px rgba(255,255,255,.72);color:#320a66;}
    .chat-widget.chat-widget--max-customer-support .chat-widget__header-info{margin-left:0;}
    .chat-widget.chat-widget--max-customer-support .chat-widget__header-name{color:#fff;font-size:29px;line-height:.96;font-weight:800;letter-spacing:-.05em;text-shadow:0 6px 18px rgba(0,0,0,.24);}
    .chat-widget.chat-widget--max-customer-support .chat-widget__header-status{margin-top:8px;color:rgba(233,225,255,.86);font-size:12px;line-height:1.4;max-width:240px;}
    .chat-widget.chat-widget--max-customer-support .chat-widget__header-status::before{background:#58f4ff;box-shadow:0 0 10px rgba(88,244,255,.88);}
    .chat-widget.chat-widget--max-customer-support .chat-widget__header-actions{gap:10px;}
    .chat-widget.chat-widget--max-customer-support .chat-widget__header-btn{width:34px;height:34px;border:1px solid rgba(255,255,255,.16);background:linear-gradient(180deg, rgba(255,255,255,.14), rgba(95,32,172,.24));color:#f8d8ff;box-shadow:0 12px 24px rgba(14,0,52,.26), inset 0 1px 0 rgba(255,255,255,.22);backdrop-filter:blur(6px);}
    .chat-widget.chat-widget--max-customer-support .chat-widget__header-btn:hover{background:linear-gradient(180deg, rgba(255,255,255,.2), rgba(119,46,205,.4));color:#fff;}
    .chat-widget.chat-widget--max-customer-support .chat-widget__messages{position:relative;z-index:2;background:transparent;padding:18px 20px 16px;gap:18px;}
    .chat-widget.chat-widget--max-customer-support .chat-widget__divider{color:rgba(195,186,235,.66);}
    .chat-widget.chat-widget--max-customer-support .chat-widget__divider::before,.chat-widget.chat-widget--max-customer-support .chat-widget__divider::after{background:linear-gradient(90deg, rgba(104,79,199,.04), rgba(104,79,199,.62), rgba(104,79,199,.04));}
    .chat-widget.chat-widget--max-customer-support .msg{max-width:100%;}
    .chat-widget.chat-widget--max-customer-support .msg--other{padding-right:54px;}
    .chat-widget.chat-widget--max-customer-support .msg--me{padding-left:54px;}
    .chat-widget.chat-widget--max-customer-support .msg__avatar{width:34px;height:34px;border:1px solid rgba(255,255,255,.28);background:linear-gradient(145deg, #28d7ff 0%, #7455ff 100%);box-shadow:0 10px 20px rgba(8,0,30,.26);}
    .chat-widget.chat-widget--max-customer-support .msg__bubble{min-width:164px;max-width:304px;padding:18px 20px 16px;border-radius:28px;border:1px solid rgba(255,255,255,.18);box-shadow:0 18px 28px rgba(11,0,36,.28), inset 0 1px 0 rgba(255,255,255,.22), inset 0 -12px 18px rgba(0,0,0,.08);backdrop-filter:blur(5px);transform-style:preserve-3d;}
    .chat-widget.chat-widget--max-customer-support .msg--other .msg__bubble{background:linear-gradient(135deg, #2ce0ff 0%, #1aa2ff 52%, #1074dd 100%);color:#f7ffff;border-bottom-left-radius:12px;transform:perspective(900px) rotateY(17deg) rotateX(8deg);}
    .chat-widget.chat-widget--max-customer-support .msg--me .msg__bubble{background:linear-gradient(135deg, #ffd39b 0%, #ffb66c 48%, #f08b4f 100%);color:#45220f;border-bottom-right-radius:12px;transform:perspective(900px) rotateY(-17deg) rotateX(8deg);}
    .chat-widget.chat-widget--max-customer-support .msg__header{display:none;}
    .chat-widget.chat-widget--max-customer-support .msg__text{font-size:14px;line-height:1.42;letter-spacing:.01em;}
    .chat-widget.chat-widget--max-customer-support .typing-bubble{background:linear-gradient(135deg, rgba(44,224,255,.92), rgba(32,112,220,.92));color:#fff;border-radius:26px;border-bottom-left-radius:12px;box-shadow:0 18px 28px rgba(11,0,36,.24);}
    .chat-widget.chat-widget--max-customer-support .chat-options{justify-content:flex-start;gap:12px;padding:0;}
    .chat-widget.chat-widget--max-customer-support .chat-option-btn{border:1px solid rgba(255,255,255,.18);background:linear-gradient(180deg, rgba(255,255,255,.12), rgba(113,34,199,.34));color:#fff;border-radius:22px;padding:10px 16px;box-shadow:0 12px 24px rgba(12,0,42,.24);}
    .chat-widget.chat-widget--max-customer-support .chat-option-btn:hover{background:linear-gradient(180deg, rgba(255,255,255,.18), rgba(134,44,226,.48));color:#fff;transform:translateY(-1px);}
    .chat-widget.chat-widget--max-customer-support .chat-widget__input-row{position:relative;z-index:2;margin:0 18px 18px;padding:14px;border-top:none;border-radius:28px;background:rgba(21,6,56,.76);border:1px solid rgba(170,132,255,.24);box-shadow:0 18px 30px rgba(10,0,36,.28), inset 0 1px 0 rgba(255,255,255,.08);backdrop-filter:blur(10px);}
    .chat-widget.chat-widget--max-customer-support .chat-widget__input{background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.1);color:#fff;}
    .chat-widget.chat-widget--max-customer-support .chat-widget__input::placeholder{color:rgba(224,212,255,.54);}
    .chat-widget.chat-widget--max-customer-support .chat-widget__input-row .chat-widget__send{background:linear-gradient(145deg, #ff59cf 0%, #9f53ff 45%, #4cb8ff 100%);border:1px solid rgba(255,255,255,.22);box-shadow:0 14px 24px rgba(13,0,52,.28), inset 0 2px 3px rgba(255,255,255,.42);}
    .chat-widget.chat-widget--max-customer-support .chat-widget__input-row .chat-widget__send:hover{transform:translateY(-2px) scale(1.02);}
    .chat-widget.chat-widget--max-customer-support .chat-widget__footer{position:relative;z-index:2;background:transparent;border-top:none;color:rgba(224,212,255,.68);}
        `;
        document.head.appendChild(maxCustomerSupportStyle);
    }
    if (!document.getElementById('astig-chat-max-customer-service-style')) {
        const maxCustomerServiceStyle = document.createElement('style');
        maxCustomerServiceStyle.id = 'astig-chat-max-customer-service-style';
        maxCustomerServiceStyle.textContent = `
    .chat-widget.chat-widget--max-customer-service{background:linear-gradient(180deg, #f4f7f8 0%, #eef3f4 100%);border-color:rgba(190,215,218,.92);border-radius:32px;box-shadow:0 22px 42px rgba(166,187,194,.28), inset 0 1px 0 rgba(255,255,255,.86);}
    .chat-widget.chat-widget--max-customer-service::before{content:'';position:absolute;inset:0;border-radius:32px;background:radial-gradient(circle at 100% 0%, rgba(132,215,226,.26), transparent 28%);pointer-events:none;}
    .chat-widget.chat-widget--max-customer-service .chat-widget__header{position:relative;z-index:2;background:transparent;border-bottom:none;padding:22px 22px 10px;gap:12px;}
    .chat-widget.chat-widget--max-customer-service .chat-widget__header-avatar{width:52px;height:52px;border-radius:18px;background:linear-gradient(180deg, #86e8e1 0%, #63d2e8 58%, #7fa6ff 100%);border:1px solid rgba(95,220,226,.72);box-shadow:0 10px 18px rgba(136,212,224,.42), inset 0 3px 6px rgba(255,255,255,.34);color:#fff;}
    .chat-widget.chat-widget--max-customer-service .chat-widget__header-name{color:#68758c;font-size:26px;line-height:1;font-weight:800;letter-spacing:-.04em;}
    .chat-widget.chat-widget--max-customer-service .chat-widget__header-status{margin-top:6px;color:#9aa7b9;max-width:270px;}
    .chat-widget.chat-widget--max-customer-service .chat-widget__header-status::before{background:#8be1e8;box-shadow:0 0 10px rgba(129,224,231,.8);}
    .chat-widget.chat-widget--max-customer-service .chat-widget__header-actions{gap:10px;}
    .chat-widget.chat-widget--max-customer-service .chat-widget__header-btn{width:34px;height:34px;border:1px solid rgba(201,213,223,.95);background:linear-gradient(180deg, #fff 0%, #edf1f4 100%);color:#91a0b4;box-shadow:0 8px 16px rgba(206,214,225,.58), inset 0 1px 0 rgba(255,255,255,.94);}
    .chat-widget.chat-widget--max-customer-service .chat-widget__header-btn:hover{background:linear-gradient(180deg, #fff 0%, #e7eef1 100%);color:#6f8198;}
    .chat-widget.chat-widget--max-customer-service .chat-widget__messages{position:relative;z-index:2;background:transparent;padding:14px 18px 18px;gap:18px;}
    .chat-widget.chat-widget--max-customer-service .chat-widget__divider{color:#a8b6c2;}
    .chat-widget.chat-widget--max-customer-service .chat-widget__divider::before,.chat-widget.chat-widget--max-customer-service .chat-widget__divider::after{background:linear-gradient(90deg, rgba(174,193,206,.04), rgba(174,193,206,.68), rgba(174,193,206,.04));}
    .chat-widget.chat-widget--max-customer-service .msg{gap:14px;}
    .chat-widget.chat-widget--max-customer-service .msg__avatar{display:none;}
    .chat-widget.chat-widget--max-customer-service .msg__bubble{min-width:112px;max-width:270px;padding:18px 20px 18px;border-radius:24px;border:1px solid rgba(219,228,234,.95);box-shadow:0 12px 22px rgba(211,219,228,.72), inset 0 3px 5px rgba(255,255,255,.74);position:relative;}
    .chat-widget.chat-widget--max-customer-service .msg--other .msg__bubble{background:linear-gradient(180deg, #79e1df 0%, #59d0e6 58%, #72a1ff 100%);border-color:rgba(88,210,224,.9);color:#fff;}
    .chat-widget.chat-widget--max-customer-service .msg--other .msg__bubble::after{content:'';position:absolute;left:-14px;bottom:12px;width:24px;height:22px;border-bottom-right-radius:20px;background:linear-gradient(180deg, #79e1df 0%, #5fd4e5 55%, #74a3ff 100%);clip-path:polygon(100% 0, 100% 100%, 0 100%);box-shadow:-5px 7px 10px rgba(190,214,223,.35);}
    .chat-widget.chat-widget--max-customer-service .msg--me .msg__bubble{background:linear-gradient(180deg, #f3f1f7 0%, #ececf5 100%);border-color:rgba(227,225,237,.96);color:#a2a5b8;}
    .chat-widget.chat-widget--max-customer-service .msg--me .msg__bubble::after{content:'';position:absolute;right:-14px;bottom:12px;width:24px;height:22px;border-bottom-left-radius:20px;background:linear-gradient(180deg, #f3f1f7 0%, #ececf5 100%);clip-path:polygon(0 0, 100% 100%, 0 100%);box-shadow:5px 7px 10px rgba(214,218,230,.28);}
    .chat-widget.chat-widget--max-customer-service .msg__header{display:none;}
    .chat-widget.chat-widget--max-customer-service .msg__text{font-size:14px;line-height:1.28;}
    .chat-widget.chat-widget--max-customer-service .typing-bubble{background:linear-gradient(180deg, #79e1df 0%, #59d0e6 58%, #72a1ff 100%);border-radius:24px;color:#fff;box-shadow:0 12px 20px rgba(192,214,224,.56);}
    .chat-widget.chat-widget--max-customer-service .chat-options{padding:0;justify-content:flex-start;gap:12px;}
    .chat-widget.chat-widget--max-customer-service .chat-option-btn{border:1px solid rgba(197,215,221,.95);background:linear-gradient(180deg, #fff 0%, #edf2f4 100%);color:#7d91a5;border-radius:18px;box-shadow:0 10px 18px rgba(214,221,227,.6);}
    .chat-widget.chat-widget--max-customer-service .chat-option-btn:hover{background:linear-gradient(180deg, #fff 0%, #e8eff2 100%);color:#61758d;}
    .chat-widget.chat-widget--max-customer-service .chat-widget__input-row{position:relative;z-index:2;margin:0 18px 18px;padding:12px;border-top:none;border-radius:24px;background:linear-gradient(180deg, rgba(255,255,255,.96) 0%, rgba(240,245,247,.94) 100%);border:1px solid rgba(204,219,225,.95);box-shadow:0 12px 24px rgba(213,222,228,.58), inset 0 1px 0 rgba(255,255,255,.92);}
    .chat-widget.chat-widget--max-customer-service .chat-widget__input{background:rgba(255,255,255,.94);border:1px solid rgba(218,227,232,.95);color:#7d8ea2;}
    .chat-widget.chat-widget--max-customer-service .chat-widget__input::placeholder{color:#a9b6c1;}
    .chat-widget.chat-widget--max-customer-service .chat-widget__input-row .chat-widget__send{background:linear-gradient(180deg, #7ee3df 0%, #5ed1e6 58%, #73a2ff 100%);border:1px solid rgba(98,211,225,.84);box-shadow:0 12px 22px rgba(189,214,224,.62), inset 0 2px 4px rgba(255,255,255,.38);}
    .chat-widget.chat-widget--max-customer-service .chat-widget__footer{position:relative;z-index:2;background:transparent;border-top:none;color:#9baaba;}
        `;
        document.head.appendChild(maxCustomerServiceStyle);
    }
    if (!document.getElementById('astig-chat-max-customer-service-2-style')) {
        const maxCustomerService2Style = document.createElement('style');
        maxCustomerService2Style.id = 'astig-chat-max-customer-service-2-style';
        maxCustomerService2Style.textContent = `
    .chat-widget.chat-widget--max-customer-service-2{background:linear-gradient(180deg, #7a347a 0%, #d2a0d1 100%);border-color:rgba(248,215,246,.5);border-radius:40px;box-shadow:0 30px 48px rgba(141,82,145,.26);}
    .chat-widget.chat-widget--max-customer-service-2 .chat-widget__header{position:relative;z-index:2;min-height:78px;background:linear-gradient(180deg, #efb0e8 0%, #df9fe0 100%);border-bottom:none;padding:18px 22px 0;}
    .chat-widget.chat-widget--max-customer-service-2 .chat-widget__header::before{content:'';position:absolute;left:28px;top:22px;width:20px;height:20px;border-radius:50%;background:#f8f7f5;box-shadow:36px 0 0 #d29ad3,72px 0 0 #6b5472;}
    .chat-widget.chat-widget--max-customer-service-2 .chat-widget__header-avatar,.chat-widget.chat-widget--max-customer-service-2 .chat-widget__header-info,.chat-widget.chat-widget--max-customer-service-2 .chat-widget__header-actions{display:none;}
    .chat-widget.chat-widget--max-customer-service-2 .chat-widget__messages{position:relative;z-index:2;background:linear-gradient(180deg, rgba(248,243,250,.86) 0%, rgba(238,226,242,.88) 100%);padding:24px 30px 18px;gap:22px;}
    .chat-widget.chat-widget--max-customer-service-2 .chat-widget__divider{display:none;}
    .chat-widget.chat-widget--max-customer-service-2 .msg{gap:0;}
    .chat-widget.chat-widget--max-customer-service-2 .msg__avatar{display:none;}
    .chat-widget.chat-widget--max-customer-service-2 .msg--other{justify-content:flex-start;padding-right:72px;}
    .chat-widget.chat-widget--max-customer-service-2 .msg--me{justify-content:flex-end;padding-left:72px;}
    .chat-widget.chat-widget--max-customer-service-2 .msg__bubble{min-width:180px;max-width:250px;padding:18px 22px;border-radius:20px;position:relative;border:1px solid rgba(230,224,235,.95);box-shadow:0 14px 24px rgba(215,206,224,.72), inset 0 2px 5px rgba(255,255,255,.92);}
    .chat-widget.chat-widget--max-customer-service-2 .msg--other .msg__bubble{background:linear-gradient(180deg, #fdfefe 0%, #f4f8f7 100%);color:#b0b4c0;}
    .chat-widget.chat-widget--max-customer-service-2 .msg--other .msg__bubble::after{content:'';position:absolute;left:0;bottom:-18px;width:30px;height:28px;background:linear-gradient(180deg, #fdfefe 0%, #f4f8f7 100%);clip-path:polygon(0 0, 100% 0, 0 100%);box-shadow:-3px 8px 10px rgba(222,214,230,.35);}
    .chat-widget.chat-widget--max-customer-service-2 .msg--me .msg__bubble{background:linear-gradient(180deg, #f7fbfc 0%, #eef4f4 100%);color:#b0b4c0;}
    .chat-widget.chat-widget--max-customer-service-2 .msg--me .msg__bubble::after{content:'';position:absolute;right:0;bottom:-18px;width:30px;height:28px;background:linear-gradient(180deg, #f7fbfc 0%, #eef4f4 100%);clip-path:polygon(100% 0, 100% 100%, 0 0);box-shadow:3px 8px 10px rgba(222,214,230,.35);}
    .chat-widget.chat-widget--max-customer-service-2 .msg__header{display:none;}
    .chat-widget.chat-widget--max-customer-service-2 .msg__text{font-size:14px;line-height:1.24;}
    .chat-widget.chat-widget--max-customer-service-2 .typing-bubble{background:linear-gradient(180deg, #fdfefe 0%, #f4f8f7 100%);color:#b0b4c0;border-radius:20px;}
    .chat-widget.chat-widget--max-customer-service-2 .chat-options{justify-content:flex-start;padding:0;gap:12px;}
    .chat-widget.chat-widget--max-customer-service-2 .chat-option-btn{background:linear-gradient(180deg, #ffffff 0%, #f3f6f8 100%);border:1px solid rgba(229,223,236,.95);color:#a69db0;border-radius:18px;box-shadow:0 10px 18px rgba(214,206,223,.6);}
    .chat-widget.chat-widget--max-customer-service-2 .chat-widget__input-row{position:relative;z-index:2;margin:0;padding:16px 22px 18px;background:linear-gradient(180deg, #efb0e8 0%, #d99edc 100%);border-top:none;border-bottom-left-radius:40px;border-bottom-right-radius:40px;gap:14px;}
    .chat-widget.chat-widget--max-customer-service-2 .chat-widget__input{background:linear-gradient(180deg, #fbfcfd 0%, #f4f6f7 100%);border:1px solid rgba(231,225,236,.95);color:#a1a7b4;box-shadow:0 10px 18px rgba(212,204,222,.58);}
    .chat-widget.chat-widget--max-customer-service-2 .chat-widget__input::placeholder{color:#b2b4be;}
    .chat-widget.chat-widget--max-customer-service-2 .chat-widget__input-row .chat-widget__send:first-child{display:none;}
    .chat-widget.chat-widget--max-customer-service-2 .chat-widget__input-row .chat-widget__send{background:linear-gradient(180deg, #9e62ab 0%, #6d2f7b 100%);border:1px solid rgba(122,63,138,.88);box-shadow:0 12px 22px rgba(138,88,146,.48), inset 0 2px 4px rgba(255,255,255,.18);}
    .chat-widget.chat-widget--max-customer-service-2 .chat-widget__footer{display:none !important;}
        `;
        document.head.appendChild(maxCustomerService2Style);
    }
    ...
    const isMaxCustomerService2Template = templateStyle === 'max-customer-service-2';
        ...
        const headerBgInlineStyle = (config.theme && config.theme.headerBgColor && !isMaximumSupportTemplate && !isOrdersOnlineTemplate && !isMaxCustomerSupportTemplate && !isMaxCustomerServiceTemplate && !isMaxCustomerService2Template)
        ...
        let widgetTemplateClass = '';
        if (isSupportTemplate) {
            widgetTemplateClass = ' chat-widget--support-reference';
        } else if (isMaximumSupportTemplate) {
            widgetTemplateClass = ' chat-widget--maximum-support';
        } else if (isOrdersOnlineTemplate) {
            widgetTemplateClass = ' chat-widget--orders-online';
        } else if (isMaxCustomerSupportTemplate) {
            widgetTemplateClass = ' chat-widget--max-customer-support';
        } else if (isMaxCustomerServiceTemplate) {
            widgetTemplateClass = ' chat-widget--max-customer-service';
        } else if (isMaxCustomerService2Template) {
            widgetTemplateClass = ' chat-widget--max-customer-service-2';
        }
        let inputPlaceholder = 'Type a message...';
        if (isSupportTemplate) {
            inputPlaceholder = 'Or send a message...';
        } else if (isMaximumSupportTemplate) {
            inputPlaceholder = 'Ask a question...';
        } else if (isOrdersOnlineTemplate) {
            inputPlaceholder = 'Enter your message...';
        } else if (isMaxCustomerSupportTemplate) {
            inputPlaceholder = 'Step into support...';
        } else if (isMaxCustomerServiceTemplate) {
            inputPlaceholder = 'Write a service reply...';
        } else if (isMaxCustomerService2Template) {
