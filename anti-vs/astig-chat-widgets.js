...
(function() {
  ...
  window.RSVPChatConfig.fullConfig = {"theme":{"primaryColor":"#ff1493","bgColor":"#ffd1e8","surfaceColor":"#fff4fb","fontFamily":"'Inter', sans-serif","borderRadius":24,"mode":"gradient","gradient":{"start":"#ff69b4","end":"#ff1493"},"headerBgColor":"#f4a5cf","headerTextColor":"#1f1140","topHeroMediaType":"image","topHeroMediaUrl":"https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=1000&q=80"},"header":{"title":"Martha","name":"Martha","status":"Event RSVP Agent","fontFamily":"'Syne', sans-serif","nameFontSize":16,"nameFontWeight":700,"statusFontSize":12,"animation":"none","logoOffsetX":0,"logoOffsetY":0,"nameOffsetX":0,"nameOffsetY":0,"statusOffsetX":0,"statusOffsetY":0,"avatar":"M","avatarSize":40,"logoSize":46,"logoType":"image","logoUrl":"https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=240&q=80"},"assistant":{"name":"Martha"},"user":{"avatar":"","avatarSize":0},"launcher":{"position":"bottom-right","iconType":"icon","icon":"calendar-heart","imageUrl":"","size":54,"badgeEnabled":true,"text":"Martha is here to help","bubbleEnabled":true,"bubbleText":"Hi! I'm Martha, your Event RSVP Agent. How can I help you today?","bubbleMode":"typewriter","bubbleTimed":true,"bubbleDelaySec":5,"bubbleDurationSec":10,"bgStyle":"gradient","bgColor":"#ff69b4","gradientEnd":"#ff1493","animation":"pulse"},"video":{"layout":"inline","hideBehavior":"first-question","loop":false,"url":"","imageUrl":""},"questions":[{"id":1,"text":"Hi! I'm Martha, your Event RSVP Agent. How can I help you today?","type":"choice","displayMode":"instant","choices":"RSVP Now,View Location,Chat"},{"id":2,"text":"Great! Please share your full name, email, event date, and number of guests.","type":"text","displayMode":"instant","choices":""},{"id":3,"text":"Would you like to RSVP as Yes, No, or Maybe?","type":"choice","displayMode":"instant","choices":"Yes,No,Maybe"}],"questionsStyle":"solid","webhook":{"url":"https://n8n.srv1291312.hstgr.cloud/webhook/a4d3520b-1922-4e9b-b162-3b15a5060985/chat","testUrl":"","chatUrl":"https://n8n.srv1291312.hstgr.cloud/webhook/a4d3520b-1922-4e9b-b162-3b15a5060985/chat","production":true,"externalJsUrl":"https://cdn.jsdelivr.net/gh/majesticwebcreation-ui/astig.media/anti-vs/astig-chat-widgets.js"},"footer":{"text":"POWERED BY ASTIG MEDIA","url":"","fontFamily":"'Inter', sans-serif","animation":"none","textColor":"#8a3f73","fontSize":10,"position":"center"},"ui":{"showPipelineMonitor":false,"showRealtimeTelemetry":false,"showRealtimeFeed":false,"templateStyle":"event-rsvp-martha"}};
  try {
...
(function() {
    ...
    const defaultBundleConfig = {"theme":{"primaryColor":"#ff1493","bgColor":"#ffd1e8","surfaceColor":"#fff4fb","fontFamily":"'Inter', sans-serif","borderRadius":24,"mode":"gradient","gradient":{"start":"#ff69b4","end":"#ff1493"},"headerBgColor":"#f4a5cf","headerTextColor":"#1f1140","topHeroMediaType":"image","topHeroMediaUrl":"https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=1000&q=80"},"header":{"title":"Martha","name":"Martha","status":"Event RSVP Agent","fontFamily":"'Syne', sans-serif","nameFontSize":16,"nameFontWeight":700,"statusFontSize":12,"animation":"none","logoOffsetX":0,"logoOffsetY":0,"nameOffsetX":0,"nameOffsetY":0,"statusOffsetX":0,"statusOffsetY":0,"avatar":"M","avatarSize":40,"logoSize":46,"logoType":"image","logoUrl":"https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=240&q=80"},"assistant":{"name":"Martha"},"user":{"avatar":"","avatarSize":0},"launcher":{"position":"bottom-right","iconType":"icon","icon":"calendar-heart","imageUrl":"","size":54,"badgeEnabled":true,"text":"Martha is here to help","bubbleEnabled":true,"bubbleText":"Hi! I'm Martha, your Event RSVP Agent. How can I help you today?","bubbleMode":"typewriter","bubbleTimed":true,"bubbleDelaySec":5,"bubbleDurationSec":10,"bgStyle":"gradient","bgColor":"#ff69b4","gradientEnd":"#ff1493","animation":"pulse"},"video":{"layout":"inline","hideBehavior":"first-question","loop":false,"url":"","imageUrl":""},"questions":[{"id":1,"text":"Hi! I'm Martha, your Event RSVP Agent. How can I help you today?","type":"choice","displayMode":"instant","choices":"RSVP Now,View Location,Chat"},{"id":2,"text":"Great! Please share your full name, email, event date, and number of guests.","type":"text","displayMode":"instant","choices":""},{"id":3,"text":"Would you like to RSVP as Yes, No, or Maybe?","type":"choice","displayMode":"instant","choices":"Yes,No,Maybe"}],"questionsStyle":"solid","webhook":{"url":"https://n8n.srv1291312.hstgr.cloud/webhook/a4d3520b-1922-4e9b-b162-3b15a5060985/chat","testUrl":"","chatUrl":"https://n8n.srv1291312.hstgr.cloud/webhook/a4d3520b-1922-4e9b-b162-3b15a5060985/chat","production":true,"externalJsUrl":"https://cdn.jsdelivr.net/gh/majesticwebcreation-ui/astig.media/anti-vs/astig-chat-widgets.js"},"footer":{"text":"POWERED BY ASTIG MEDIA","url":"","fontFamily":"'Inter', sans-serif","animation":"none","textColor":"#8a3f73","fontSize":10,"position":"center"},"ui":{"showPipelineMonitor":false,"showRealtimeTelemetry":false,"showRealtimeFeed":false,"templateStyle":"event-rsvp-martha"}};
    ...
    function renderLauncher() {
        ...
        if (document.getElementById('astig-chat-wrapper')) return;
