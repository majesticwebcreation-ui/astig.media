...
(function() {
  var __astigDeployStamp = "2026-03-08T09:05:07.211Z";
  ...
  if (!window.RSVPChatConfig.fullConfig || typeof window.RSVPChatConfig.fullConfig !== 'object') window.RSVPChatConfig.fullConfig = {"theme":{"primaryColor":"#ef9ae3","bgColor":"#d8a4d5","surfaceColor":"#ecdaf0","fontFamily":"'DM Sans', sans-serif","borderRadius":30,"mode":"solid","gradient":{"start":"#6c63ff","end":"#ff6584"},"headerBgColor":"#e9abe0","headerTextColor":"#ffffff","topHeroMediaType":"none","topHeroMediaUrl":""},"header":{"title":"Max Customer Service 2","name":"Max Customer Service 2","status":"","fontFamily":"'Syne', sans-serif","nameFontSize":15,"nameFontWeight":700,"statusFontSize":12,"animation":"none","logoOffsetX":0,"logoOffsetY":0,"nameOffsetX":0,"nameOffsetY":0,"statusOffsetX":0,"statusOffsetY":0,"avatar":"MS","avatarSize":"40","logoSize":"0","logoType":"text","logoUrl":""},"assistant":{"name":"Max Service 2"},"user":{"avatar":"","avatarSize":"0"},"launcher":{"position":"bottom-right","iconType":"icon","icon":"message-circle-more","imageUrl":"","size":"54","badgeEnabled":false,"text":"","bubbleEnabled":false,"bubbleText":"Ta-da! You've found your creative superpower spot.","bubbleMode":"instant","bubbleTimed":false,"bubbleDelaySec":5,"bubbleDurationSec":10,"bgStyle":"gradient","bgColor":"#e6a5de","gradientEnd":"#8a4ea4","animation":"pulse"},"video":{"layout":"inline","hideBehavior":"first-question","loop":false,"url":"","imageUrl":""},"questions":[{"id":1,"text":"Welcome to Max Customer Service 2.","type":"text","displayMode":"instant","choices":""},{"id":2,"text":"What can we help you with?","type":"choice","displayMode":"instant","choices":"General support,Account help,Send a message"}],"questionsStyle":"solid","webhook":{"url":"https://n8n.srv1291312.hstgr.cloud/webhook/a4d3520b-1922-4e9b-b162-3b15a5060985/chat","testUrl":"","chatUrl":"https://n8n.srv1291312.hstgr.cloud/webhook/a4d3520b-1922-4e9b-b162-3b15a5060985/chat","activeMode":"production","production":true,"externalJsUrl":"https://cdn.jsdelivr.net/gh/majesticwebcreation-ui/astig.media@main/anti-vs/fwidgets-chat-embed-runtime.js"},"auth":{"enabled":true,"headerName":"Authorization","headerPrefix":"Bearer","headerValue":"","useForWebhook":true,"withCredentials":false},"footer":{"text":"","url":"","fontFamily":"'Inter', sans-serif","animation":"none","textColor":"#7070a0","fontSize":"11","position":"center"},"ui":{"showPipelineMonitor":false,"showRealtimeTelemetry":false,"showRealtimeFeed":false,"templateStyle":"max-customer-service-2"}};
...
(function() {
    ...
    const defaultBundleConfig = {"theme":{"primaryColor":"#ef9ae3","bgColor":"#d8a4d5","surfaceColor":"#ecdaf0","fontFamily":"'DM Sans', sans-serif","borderRadius":30,"mode":"solid","gradient":{"start":"#6c63ff","end":"#ff6584"},"headerBgColor":"#e9abe0","headerTextColor":"#ffffff","topHeroMediaType":"none","topHeroMediaUrl":""},"header":{"title":"Max Customer Service 2","name":"Max Customer Service 2","status":"","fontFamily":"'Syne', sans-serif","nameFontSize":15,"nameFontWeight":700,"statusFontSize":12,"animation":"none","logoOffsetX":0,"logoOffsetY":0,"nameOffsetX":0,"nameOffsetY":0,"statusOffsetX":0,"statusOffsetY":0,"avatar":"MS","avatarSize":"40","logoSize":"0","logoType":"text","logoUrl":""},"assistant":{"name":"Max Service 2"},"user":{"avatar":"","avatarSize":"0"},"launcher":{"position":"bottom-right","iconType":"icon","icon":"message-circle-more","imageUrl":"","size":"54","badgeEnabled":false,"text":"","bubbleEnabled":false,"bubbleText":"Ta-da! You've found your creative superpower spot.","bubbleMode":"instant","bubbleTimed":false,"bubbleDelaySec":5,"bubbleDurationSec":10,"bgStyle":"gradient","bgColor":"#e6a5de","gradientEnd":"#8a4ea4","animation":"pulse"},"video":{"layout":"inline","hideBehavior":"first-question","loop":false,"url":"","imageUrl":""},"questions":[{"id":1,"text":"Welcome to Max Customer Service 2.","type":"text","displayMode":"instant","choices":""},{"id":2,"text":"What can we help you with?","type":"choice","displayMode":"instant","choices":"General support,Account help,Send a message"}],"questionsStyle":"solid","webhook":{"url":"https://n8n.srv1291312.hstgr.cloud/webhook/a4d3520b-1922-4e9b-b162-3b15a5060985/chat","testUrl":"","chatUrl":"https://n8n.srv1291312.hstgr.cloud/webhook/a4d3520b-1922-4e9b-b162-3b15a5060985/chat","activeMode":"production","production":true,"externalJsUrl":"https://cdn.jsdelivr.net/gh/majesticwebcreation-ui/astig.media@main/anti-vs/fwidgets-chat-embed-runtime.js"},"auth":{"enabled":true,"headerName":"Authorization","headerPrefix":"Bearer","headerValue":"","useForWebhook":true,"withCredentials":false},"footer":{"text":"","url":"","fontFamily":"'Inter', sans-serif","animation":"none","textColor":"#7070a0","fontSize":"11","position":"center"},"ui":{"showPipelineMonitor":false,"showRealtimeTelemetry":false,"showRealtimeFeed":false,"templateStyle":"max-customer-service-2"}};
